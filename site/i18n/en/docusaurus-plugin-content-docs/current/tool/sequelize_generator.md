...
Generate `Sequelize` entities for `Midway` through an existing database.

For other detailed documents and usage, please refer to [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto).
