...
| [@mwcp/kmore][@mwcp/kmore]                   | waitingsong | midway Database QueryBuilder based on [Knex], declarative transaction via `Transactional` decorator, integrated [OpenTelemetry] trace                                                                                                                             |
