...
const initializeMethod = async (initializeContext = {}) => {
  ...
  starter.loader.loadDirectory({ baseDir: '/Users/soar.gy/project/faas/github/midway/packages/faas-dev-pack/test/fixtures/base-fn-apigw/.faas_debug_tmp/faas_tmp_out/src'});
  await starter.start();
   inited = true; 
};
