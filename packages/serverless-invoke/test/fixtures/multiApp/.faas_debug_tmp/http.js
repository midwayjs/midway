...
const initializeMethod = async (initializeContext = {}) => {
  ...
  starter.loader.loadDirectory({ baseDir: '/Users/soar.gy/project/faas/github/midway/packages/serverless-invoke/test/fixtures/multiApp/.faas_debug_tmp/faas_tmp_out/src'});
  await starter.start();
  inited = true;
};
