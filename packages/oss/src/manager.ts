...
export class OSSService implements OSS {
  ...
  //   return this.instance.completeMultipartUpload(
  //     name,
  //     uploadId,
  //     parts,
  //     options
  ...
  //   options?: OSS.RequestOptions
  // ): Promise<OSS.NormalSuccessResponse> {
  //   return this.instance.putBucketReferer(name, allowEmpty, referers, options);
  // }
  //
  // putBucketWebsite(
  //   name: string,
  ...
  //   return this.instance.uploadPart(
  //     name,
  //     uploadId,
  //     partNo,
  //     file,
  ...
  //   }
  // ): Promise<OSS.UploadPartResult> {
  //   return this.instance.uploadPartCopy(
  //     name,
  //     uploadId,
  //     partNo,
  //     range,
